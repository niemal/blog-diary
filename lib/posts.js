...
export function getPostData(id) {
    ...
    content = content.replaceAll('<h1', `<h1 class="text-xl lg:text-5xl font-bold text-white mb-2 lg:mb-6 pt-3" `);
    content = content.replaceAll('<h2', `<h2 class="text-xl lg:text-3xl font-bold text-white mb-2 lg:mb-6 pt-3" `);

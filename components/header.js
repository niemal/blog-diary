        ...
        <div>
            ...
            <header>
                <div id={styles.social} className="mt-6">
                    <a className={`${styles.social}`} href="https://twitter.com/niemal/"><Image src="/twitter.svg" width={30} height={30} /></a>
                    <a className={`${styles.social} ml-8`} href="https://github.com/niemal/"><Image src="/github.svg" width={30} height={30} /></a>
                </div>
                <nav id={`${styles.navbar}`} className={`flex justify-center items-center p-1 mx-auto ${styles.sticky}`}>
                    ...
                    <Image src="/butterfly.svg" className={`inline-block lg:mt-0 mr-5`} height={75} width={75} />

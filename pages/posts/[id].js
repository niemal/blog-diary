                    ...
                    <div className={`lg:w-1/2 mx-auto`}>
                        ...
                        <div id={styles.headerWrap}>
                            {postData.banner.length > 0  ? (
                                <div id={styles.headerImage} style={{ backgroundImage: `url('${postData.banner}')` }}></div>
                            ) : '' }

                            <div className={`${styles.date} justify-center mt-6 font-bold flex`}>
                                <Image src="/blog/clock.svg" alt={''} className={`flex-col`} width={20} height={18} />
                                <span className={`ml-1 font-bold flex-col`}>{postData.time}</span>
                            </div>
                            <div id={styles.tags}>
